...
try{ 
	...
	String sq ="select SUM(TEL_amount) TEL_amount from `telephone`  ";
	resultSet1 = statement1.executeQuery(sq);
	while(resultSet1.next()){
	%> 
	<B><ins>Total Amount</ins></B>:-&nbsp;&nbsp;&nbsp;&nbsp;<b><ins><%= resultSet1.getString("TEL_amount")%></ins></b>  <BR><BR>
<%String TEL=resultSet1.getString("TEL_amount");%>
...
String sql ="select id_no, SUM(TEL_amount) TEL_amount from `telephone` group by id_no ";
...
<td><%=resultSet2.getString("TEL_amount") %></td>
...
<h2 align="center"><font><strong>TELEPHONE TOTAL RECORD</strong></font></h2>
<table align="center" cellpadding="5" cellspacing="5" border="1">
<tr>
...
<td><%=resultSet.getString("TEL_amount") %></td>
