...
try{ 
	...
	String sq ="select SUM(DTH_amount) DTH_amount from `dth`  ";
	resultSet1 = statement1.executeQuery(sq);
	while(resultSet1.next()){
	%> 
	<B><ins>Total Amount</ins></B>:-&nbsp;&nbsp;&nbsp;&nbsp;<b><ins><%= resultSet1.getString("DTH_amount")%></ins></b>  <BR><BR>
<%String DTH=resultSet1.getString("DTH_amount");%>
<%session.setAttribute("DTH", DTH); %>
  		<% 
}
} catch (Exception e) {
e.printStackTrace();
...
String sql ="select id_no, SUM(DTH_amount) DTH_amount from `dth` group by id_no ";
...
<td><%=resultSet2.getString("DTH_amount") %></td>
...
%>
<h2 align="center"><font><strong>DTH TOTAL RECORD</strong></font></h2>
<table align="center" cellpadding="5" cellspacing="5" border="1">
<tr>
...
<td><%=resultSet.getString("DTH_amount") %></td>
