...
try{ 
	...
	String sq ="select SUM(DC_amount) DC_amount from `datacard`  ";
	resultSet1 = statement1.executeQuery(sq);
	while(resultSet1.next()){
	%> 
	<B><ins>Total Amount</ins></B>:-&nbsp;&nbsp;&nbsp;&nbsp;<b><ins><%= resultSet1.getString("DC_amount")%></ins></b>  <BR><BR>
<%String DC=resultSet1.getString("DC_amount");%>
...
String sql ="select id_no, SUM(DC_amount) DC_amount from `datacard` group by id_no ";
...
<td><%=resultSet2.getString("DC_amount") %></td>
...
%>
<h2 align="center"><font><strong>DATACARD TOTAL RECORD</strong></font></h2>
<table align="center" cellpadding="5" cellspacing="5" border="1">
<tr>
...
String sql ="SELECT * FROM datacard ";
...
<td><%=resultSet.getString("Datacard_No") %></td>
<td><%=resultSet.getString("DC_amount") %></td>
