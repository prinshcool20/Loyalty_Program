...
try{ 
	...
	String sq ="select SUM(BB_amount) BB_amount from `broadband`  ";
	resultSet1 = statement1.executeQuery(sq);
	while(resultSet1.next()){
	%> 
	<B><ins>Total Amount</ins></B>:-&nbsp;&nbsp;&nbsp;&nbsp;<b><ins><%= resultSet1.getString("BB_amount")%></ins></b>  <BR><BR>
<%String BB=resultSet1.getString("BB_amount");%>
...
String sql ="select id_no, SUM(BB_amount) BB_amount from `broadband` group by id_no ";
...
<td><%=resultSet2.getString("BB_amount") %></td>
...
%>
<h2 align="center"><font><strong>BROADBAND TOTAL RECORD</strong></font></h2>
<table align="center" cellpadding="5" cellspacing="5" border="1">
<tr>
...
String sql ="SELECT * FROM broadband ";
...
<td><%=resultSet.getString("Broadband_No") %></td>
<td><%=resultSet.getString("BB_amount") %></td>
