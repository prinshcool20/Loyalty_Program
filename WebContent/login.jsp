...
<body bgcolor="grey">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-6 card-panel">
      <form class="login-form" name="form" action="LoginServlet" method="post" onsubmit="return validate()">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="pillerImage.jpg" width=80 alt="" class="responsive-img valign profile-image-login">
            <p class="center login-form-text">Welcome To Kiosks Login Form</p>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input class="validate" placeholder="Id" name="id_no" type="text">
        ...
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
          <p class="margin right-align medium-small"><a href="adminlogin.jsp"><u>Login as Admin !</u></a></p>
          </div>         
        </div>
